...
def execute_queries_serial():
    intervals = [(1, 250000), (250001, 500000), (500001, 750000), (750001, 1000000), (1000001, 1250000), (1250001, 1500000), (1500001, 1750000), (1750001, 2000000)]
    port = 5440
...
def execute_queries_parallel():
    intervals = [(1, 250000), (250001, 500000), (500001, 750000), (750001, 1000000), (1000001, 1250000), (1250001, 1500000), (1500001, 1750000), (1750001, 2000000)]
    ports = [5440, 5441, 5442, 5443, 5444, 5445, 5446, 5447]
    start_time = time.time()
    processes = []
